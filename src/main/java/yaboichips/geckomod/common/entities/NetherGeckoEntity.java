...
public class NetherGeckoEntity extends GeckoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new NetherGeckoEntity.MateGoal(this, 1.0D));
        this.goalSelector.addGoal(1, new NetherGeckoEntity.LayEggGoal(this, 1.0D));
    ...
    static class LayEggGoal extends MoveToBlockGoal {
        ...
        public void tick() {
            ...
            world.setBlockState(blockpos, GBlocks.NETHER_GECKO_EGG_BLOCK.getDefaultState());
