...
public class GeckoSpitEntity extends LlamaSpitEntity {

    public GeckoSpitEntity(EntityType<? extends GeckoSpitEntity> type, World world) {
        super(type, world);
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public GeckoSpitEntity(World worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_) {
        this(GEntities.GECKOSPIT, worldIn);
