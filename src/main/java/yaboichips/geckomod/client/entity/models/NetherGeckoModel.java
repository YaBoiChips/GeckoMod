...
public class NetherGeckoModel<T extends NetherGeckoEntity> extends AgeableModel<T> {
    ...
    public NetherGeckoModel() {
        ...
        Head.setTextureOffset(0, 0).addBox(-1.0F, -3.0F, -2.5F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        Head.setTextureOffset(0, 0).addBox(1.0F, -3.0F, -2.5F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        Head.setTextureOffset(10, 1).addBox(2.0F, 0.0F, -3.0F, 1.0F, 0.0F, 2.0F, 0.0F, false);
        Head.setTextureOffset(11, 0).addBox(2.5F, 0.0F, -2.0F, 1.0F, 0.0F, 1.0F, 0.0F, false);
        ...
        leftFlap.setRotationPoint(0.0F, 0.0F, 0.0F);
        Head.addChild(leftFlap);


        rightFlap = new ModelRenderer(this);
        rightFlap.setRotationPoint(0.0F, 0.0F, 0.0F);
        Head.addChild(rightFlap);
        rightFlap.setTextureOffset(0, 12).addBox(-3.0F, 0.0F, -3.0F, 1.0F, 0.0F, 2.0F, 0.0F, false);
        rightFlap.setTextureOffset(18, 14).addBox(-3.5F, 0.0F, -2.0F, 1.0F, 0.0F, 1.0F, 0.0F, false);
        ...
        bb_main.setTextureOffset(0, 0).addBox(0.5F, -4.0F, -2.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        bb_main.setTextureOffset(0, 0).addBox(-0.5F, -4.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        bb_main.setTextureOffset(0, 0).addBox(-0.75F, -4.0F, -4.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        bb_main.setTextureOffset(0, 0).addBox(0.0F, -4.0F, -3.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        bb_main.setTextureOffset(0, 0).addBox(0.0F, -4.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
        bb_main.setTextureOffset(0, 0).addBox(1.0F, -4.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
    }

    protected NetherGeckoModel(Function<ResourceLocation, RenderType> p_i225942_1_, ModelRenderer head, ModelRenderer leftFlap, ModelRenderer rightFlap, ModelRenderer snout, ModelRenderer tail, ModelRenderer tailBack_r1, ModelRenderer tail_r1, ModelRenderer legsBackRight, ModelRenderer legsFrontRight, ModelRenderer legsFrontLeft, ModelRenderer legsBackLeft, ModelRenderer bb_main, boolean isChildHeadScaled, float childHeadOffsetY, float childHeadOffsetZ, float childHeadScale, float childBodyScale, float childBodyOffsetY) {
