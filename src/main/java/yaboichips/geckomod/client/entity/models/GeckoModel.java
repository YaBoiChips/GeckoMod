...
public class GeckoModel<T extends GeckoEntity> extends AgeableModel<T> {
    ...
    public ModelRenderer TailBack_r1;
    public ModelRenderer Tail_r1;
    public ModelRenderer legsBackRight;
    public ModelRenderer legsFrontRight;
    public ModelRenderer legsFrontLeft;
    public ModelRenderer legsBackLeft;
