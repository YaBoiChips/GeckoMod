...
public class IceGeckoBossModel<T extends IceGeckoBossEntity> extends EntityModel<T> {
    ...
    public IceGeckoBossModel() {
        ...
        cube_r4.setTextureOffset(0, 0).addBox(2.7144F, -5.2107F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        cube_r4.setTextureOffset(10, 2).addBox(2.7144F, -4.2107F, -1.5F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        ...
        cube_r7.setTextureOffset(10, 5).addBox(-1.542F, -1.9017F, 2.5F, 5.0F, 2.0F, 1.0F, 0.0F, false);
